...
//example {2, 7, 10, 10, 10, 23,56}; output must be 4

public class LastOccurenceBinarySearch {
    public static int lastOccurenceBinarySearch(int[] arr, int x) {
    	//Your code goes here
        int start = 0;
    ...
    public static void main(String[] args) {
        ...
        System.out.println(lastOccurenceBinarySearch(arr, 10)); //ouputs 2
    }
}
